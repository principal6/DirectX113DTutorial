...
int WINAPI WinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPSTR lpCmdLine, _In_ int nShowCmd)
{
	...
	ObjectSphere->Create(GenerateSphere(32));

	CGameObject* goSphere{ GameWindow.AddGameObject() };
	goSphere->ComponentTransform.Translation = XMVectorSet(0.0f, 0.0f, +3.0f, 0);
	...
	goSphere->ComponentRender.Material.MaterialAmbient =
		goSphere->ComponentRender.Material.MaterialDiffuse =
		goSphere->ComponentRender.Material.MaterialSpecular = XMFLOAT3(1.0f, 0.5f, 1.0f);
	goSphere->ComponentRender.Material.SpecularExponent = 20.0f;
	goSphere->ComponentRender.Material.SpecularIntensity = 0.8f;

	CGameObject* goFloor{ GameWindow.AddGameObject() };
	goFloor->ComponentTransform.Translation = XMVectorSet(0.0f, -1.0f, 0.0f, 0);
	goFloor->ComponentTransform.Scaling = XMVectorSet(10.0f, 1.0f, 10.0f, 0);
