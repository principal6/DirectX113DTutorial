...
void CTerrain::SetTexture(int TextureID, const string& TextureFileName)
{
	...
	m_Object3D->m_vOwnTextures[TextureID]->CreateAutoGeneratedMipMappedTextureFromFile(TextureFileName);
...
void CTerrain::AddTexture(const string& TextureFileName)
{
	...
	m_Object3D->m_vOwnTextures.back()->CreateAutoGeneratedMipMappedTextureFromFile(TextureFileName);
