	...
	for (SMaterial& Material : m_Model.vMaterials)
	{
		if (Material.bHasTexture)
		{
			...
			else
			{
				...
				if (m_Model.bAutoGenerateMipMaps)
				{
					m_vOwnTextures.back()->CreateAutoGeneratedMipMappedTextureFromFile(Material.TextureFileName);
				}
				else
				{
					m_vOwnTextures.back()->CreateNonMipMappedTextureFromFile(Material.TextureFileName);
				}
