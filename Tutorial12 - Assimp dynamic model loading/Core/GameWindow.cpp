...
void CGameWindow::CreateCBs()
{
	...
	CreateCB(sizeof(SCBVSAnimationBonesData), m_cbVSAnimationBones.GetAddressOf());
...
void CGameWindow::UpdateCBVSAnimationBones(const XMMATRIX* PtrBoneMatrices)
{
	UpdateCB(sizeof(SCBVSAnimationBonesData), m_cbVSAnimationBones.Get(), PtrBoneMatrices);

	m_DeviceContext->VSSetConstantBuffers(1, 1, m_cbVSAnimationBones.GetAddressOf());
}
