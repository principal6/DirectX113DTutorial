...
int WINAPI WinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPSTR lpCmdLine, _In_ int nShowCmd)
{
	...
	VS->Create(EShaderType::VertexShader, L"Shader\\VSDefault.hlsl", "main", KInputElementDescs, ARRAYSIZE(KInputElementDescs));
	
	CShader* PS{ GameWindow.AddShader() };
	PS->Create(EShaderType::PixelShader, L"Shader\\PSDefault.hlsl", "main");
