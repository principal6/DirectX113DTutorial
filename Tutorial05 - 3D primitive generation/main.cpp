...
int WINAPI WinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPSTR lpCmdLine, _In_ int nShowCmd)
{
	...
	CObject3D* ObjectCircle{ GameWindow.AddObject3D() };
	{
		ObjectCircle->Create(GenerateCircleXZPlane(16, XMVectorSet(0.0f, 0.8f, 0.4f, 1)));
	}

	CObject3D* ObjectSphere{ GameWindow.AddObject3D() };
	{
		ObjectSphere->Create(GenerateSphere(16, XMVectorSet(1.0f, 0.5f, 1.0f, 1)));
	}
	...
	goCube->ComponentRender.PtrObject3D = ObjectSphere;
	...
	goFloor->ComponentRender.PtrObject3D = ObjectCircle;
