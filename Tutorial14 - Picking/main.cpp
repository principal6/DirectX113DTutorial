...
int WINAPI WinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPSTR lpCmdLine, _In_ int nShowCmd)
{
	...
	GameWindow.SetGameRenderingFlags(EFlagsGameRendering::UseLighting | 
		EFlagsGameRendering::DrawMiniAxes | EFlagsGameRendering::DrawPickingData | EFlagsGameRendering::DrawBoundingSphere);
	...
	CGameObject* goFloor{ GameWindow.AddGameObject("Floor") };
	{
	...
	CGameObject* goSphere{ GameWindow.AddGameObject("Sphere") };
	{
	...
	CGameObject* goYBot{ GameWindow.AddGameObject("YBot") };
	{
	...
	CGameObject* goSkySphere{ GameWindow.AddGameObject("SkySphere") };
	{
	...
	CGameObject* goSun{ GameWindow.AddGameObject("Sun") };
	{
	...
	CGameObject* goMoon{ GameWindow.AddGameObject("Moon") };
	{
	...
	CGameObject* goCloud{ GameWindow.AddGameObject("Cloud") };
	{
	...
	while (true)
	{
		...
		else
		{
			...
			{
				GameWindow.Pick(MouseState.x, MouseState.y);
			}
			...
			PtrSpriteFont->DrawString(PtrSpriteBatch, to_string(DeltaTimeF).c_str(), XMVectorSet(0, 15, 0, 0));
			if (GameWindow.GetPickedGameObjectName())
			{
				PtrSpriteFont->DrawString(PtrSpriteBatch, GameWindow.GetPickedGameObjectName(), XMVectorSet(0, 30, 0, 0));
			}
